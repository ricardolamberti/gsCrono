	...
	public void prepareLiteralFilters(JRecords<?> r) throws Exception {
  	...
  	while (iter.hasMoreElements()) {
    	...
    	while (itFilter.hasMoreElements()) {
    		...
    		String sFilter= JTools.replace((String)filter.firstObject(), "COMPANY_CUSTOMLIST", customList.getCompany());
...
//		}
  ...
  // intenta determinar si todo el filtro se puede incluir dento de las condiciones de un join
