...
/**
  ...
  public void InicializarPanel( JWin zWin ) throws Exception {
    ...
    JFormColumnResponsive col2 = AddItemColumn(9);
...
//		}).setRefreshForm(true);
    ...
    JFormPanelResponsive panelFiltro = col2.AddItemPanel("Filtros");
    ...
    JFormPanelResponsive panelDim = col2.AddItemPanel("Filtros Dinámico");
