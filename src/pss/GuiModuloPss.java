...
//	}
	...
	public BizAction findModuleAction(String sAction) throws Exception {
		...
		if (a==null) JExcepcion.SendError("Acción Inexistente");
...
//	}
	...
	/*
	 * private JList createCustomMenuList(String zMenuId) throws Exception { BizMenu oMenu = new BizMenu(); oMenu.Read(zMenuId); JDebugPrint.logDebug("Cargando menú personalizado: " + oMenu.getDescription());
	 * 
