...
//    	sPssMainPath = JPath.class.getResource("").getFile();
 // 	JDebugPrint.logDebug("sPssMainPath: "+sPssMainPath );
	...
	public static String PssPathBackgrounds() throws Exception {
		return PssPath() + "/pss/common/layout/backgrounds";
	}
	...
	public static String normalizePath(String zPath) {
	 if (zPath.startsWith("file:///"))
		...
		while (sNormPath.startsWith("/") && System.getProperty("os.name").startsWith("Windows")  ) {
